        ...
        <div class="col-sm-6">
          <div class="card" style="background-color: rgba(255, 255, 255, 0.685);">
            <div class="card-body text-center">
                <img src="./assets/img/undraw_My_current_location_re_whmt-removebg-preview.png" width="200" alt="">
              <form method="post">
                <ul class="list-group list-group-flush">
                    <h3 class="text-center"><?php echo number_format($_SESSION['distanceKillo'],1); ?>km</h3>
                    <p class="text-center text-primary"><b>Total Distance km</b></p>
                    <h3 class="text-center">TOTAL COST</h3>
                    <p class="text-center text-success"><b>R<?php echo number_format($_SESSION['Price'],2); ?></b></p>
                    <button type="submit" name="proceedToPayMentWithLocation" class="btn btn-success">Proceed to payment</button>
                </ul>
              </form>
            </div>
            <hr>
