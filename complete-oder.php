...
<body class="index-page sidebar-collapse">
        ...
        <div class="col-sm-6">
          <div class="card" style="background-color: rgba(255, 255, 255, 0.685);">
            <div class="card-body">
              <form action="">
                <br>
                <div class="text-center"><img src="./assets/img/card.png" width="120" alt=""></div>
                <div class="text-center"><h4>TOTAL R<?php echo round($_SESSION['Price'],2); ?> </div></h4>
                <br>
                <br>
  ...
  <!--   Core JS Files   -->
  <script src="https://www.paypal.com/sdk/js?client-id=AV16y5mHpQ4pve47cyYMwO-_qKhWRFDHfiGp7oq647nicefFNqYkyJfidg_fIkIOVV2WXSjwfXZcggMo&currency=USD"></script>
        ...
        paypal.Buttons({
            ...
            createOrder: function(data, actions) {
                return actions.order.create({
                    purchase_units: [{
                        amount: {
                            value: '<?php echo round($_SESSION['Price'],2); ?>'
                        }
                    }]
                });
            },
            ...
            onApprove: function(data, actions) {
                return actions.order.capture().then(function(details) {
                    ...
                    window.location.href = "./complete-oder.php?transection=confirmation";
                });
            }
